...
"use strict";function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,n){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!n||"object"!=typeof n&&"function"!=typeof n?e:n}function _inherits(e,n){if("function"!=typeof n&&null!==n)throw new TypeError("Super expression must either be null or a function, not "+typeof n);e.prototype=Object.create(n&&n.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),n&&(Object.setPrototypeOf?Object.setPrototypeOf(e,n):e.__proto__=n)}var _createClass=function(){function e(e,n){for(var t=0;t<n.length;t++){var i=n[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(n,t,i){return t&&e(n.prototype,t),i&&e(n,i),n}}(),events=require("eventemitter2"),adapter=require("webrtc-adapter"),EventEmitter=events.EventEmitter2;module.exports=function(e){function n(e,t){_classCallCheck(this,n);var i=_possibleConstructorReturn(this,(n.__proto__||Object.getPrototypeOf(n)).call(this));return i.logger=console,i.config=e||{},i.config.iceServers=i.config.iceServers||[],i.config.constraints=i.config.constraints||{offerToReceiveAudio:1,offerToReceiveVideo:1},i.config.mediaAnswerConstraints={mandatory:{OfferToReceiveAudio:!0,OfferToReceiveVideo:!0}},i.id=i.config.id,i.sid=i.config.sid||Date.now().toString(),i.parent=i.config.parent,i.localStream=i.parent.localStream,i.stream=null,i.pc=i.createRTCPeerConnection(i.parent.config.peerConnectionConfig,i.parent.config.peerConnectionConstraints),i.pc.addStream(i.localStream),i.getLocalStreams=i.pc.getLocalStreams.bind(i.pc),i.getRemoteStreams=i.pc.getRemoteStreams.bind(i.pc),i.pc.onaddstream=i.emit.bind(i,"addStream"),i.pc.onremovestream=i.emit.bind(i,"removeStream"),i.pc.onnegotiationneeded=i.emit.bind(i,"negotiationNeeded"),i.pc.onicecandidate=i._onIceCandidate.bind(i),i.pc.ondatachannel=i._onDataChannel.bind(i),i.onAny(function(e,n){i.logger.debug("PeerConnection onAny event:",e,n),i.parent.emit.call(i.parent,e,n)}),i.on("offer",function(e){i.config.connectMediaServer?i.logger.info("Do not send mgsOffer at this time, wait iceEnd ..."):i.send("offer",e)}),i.on("answer",function(e){i.send("answer",e)}),i.on("iceCandidate",function(e){i.send("iceCandidate",e)}),i.on("iceEnd",function(e){i.config.connectMediaServer&&i.send("offer",e)}),i.on("addStream",function(e){i.stream=e.stream,i.stream.psid=(i.id||i.sid)+"_"+i.stream.id;var n=!0,t=!1,r=void 0;try{for(var o,a=i.stream.getTracks()[Symbol.iterator]();!(n=(o=a.next()).done);n=!0){var s=o.value;s.addEventListener("ended",function(){i.isAllTracksEnded(i.stream)&&(i.logger.debug("stream ended, id:",i.id),i.end())})}}catch(e){t=!0,r=e}finally{try{!n&&a.return&&a.return()}finally{if(t)throw r}}i.parent.emit("peerStreamAdded",i)}),i}return _inherits(n,e),_createClass(n,[{key:"isSupportsPeerConnections",value:function(){return"undefined"!=typeof RTCPeerConnection}},{key:"isAllTracksEnded",value:function(e){var n=!0,t=!1,i=void 0;try{for(var r,o=e.getTracks()[Symbol.iterator]();!(n=(r=o.next()).done);n=!0){var a=r.value;if("ended"!==a.readyState)return!1}}catch(e){t=!0,i=e}finally{try{!n&&o.return&&o.return()}finally{if(t)throw i}}return!0}},{key:"createRTCPeerConnection",value:function(e,n){if(this.isSupportsPeerConnections())return new RTCPeerConnection(e,n);throw"The browser does not support WebRTC (RTCPeerConnection)"}},{key:"start",value:function(){this.offer(this.config.constraints)}},{key:"end",value:function(){this.isClosed||(this.close(),this.isClosed=!0,this.parent.removePeerConnection(this),this.parent.emit("peerStreamRemoved",this))}},{key:"offer",value:function(e,n){var t=this,i=this._safeCallback(n),r=e||this.config.constraints;return"closed"===this.pc.signalingState?i("Signaling state is closed"):(this.config.connectMediaServer&&(r=null),void this.pc.createOffer(function(e){var r={type:"offer",sdp:e.sdp};t.pc.setLocalDescription(e,function(){t.logger.debug("create offer success"),n?i(null,r):t.emit("offer",r)},function(e){t.emit("error",e),i(e)})},function(e){t.emit("error",e),i(e)},r))}},{key:"answer",value:function(e,n){var t=this;n=this._safeCallback(n);var i=e||this.config.mediaAnswerConstraints;return"closed"===this.pc.signalingState?n("Signaling state is closed"):void this.pc.createAnswer(function(e){var i={type:"answer",sdp:e.sdp};t.pc.setLocalDescription(e,function(){t.logger.debug("create answer success"),t.emit("answer",i),n(null,i)},function(e){t.emit("error",e),n(e)})},function(e){t.emit("error",e),n(e)},i)}},{key:"processMessage",value:function(e){var n=this;this.logger.debug("Preparing proccess peer message",e.type,e),"offer"===e.type?this.processMsgOffer(e.payload,function(t){t?n.logger.error("Cannot process msgOffer:",t):n.answer(n.config.mediaAnswerConstraints,function(t){t?n.logger.error("Cannot create an answer message",t,e):n.logger.info("Sent the answer message to ",e)})}):"answer"===e.type?this.processMsgAnswer(e.payload,function(t){t&&n.logger.error("Cannot process msgAnswer:",t,e)}):"iceCandidate"===e.type?this.processMsgCandidate(e.payload,function(t){t&&n.logger.error("Cannot process msgCandidate:",t,e)}):this.logger.warn("Unknow message",e)}},{key:"processMsgOffer",value:function(e,n){n=this._safeCallback(n);var t=new RTCSessionDescription(e);this.pc.setRemoteDescription(t,function(){n(null)},function(e){n(e)})}},{key:"processMsgAnswer",value:function(e,n){n=this._safeCallback(n);var t=new RTCSessionDescription(e);this.pc.setRemoteDescription(t,function(){n(null)},function(e){n(e)})}},{key:"processMsgCandidate",value:function(e,n){var t=this;n=this._safeCallback(n),e.candidate&&0!==e.candidate.candidate.indexOf("a=")&&(e.candidate.candidate="a="+e.candidate.candidate);var i=new RTCIceCandidate(e.candidate);this.pc.addIceCandidate(i,function(){},function(e){t.emit("error",e)}),n(null)}},{key:"close",value:function(){this.pc.close(),this.emit("close")}},{key:"addStream",value:function(e){this.logger.debug("Got the stream!"),this.localStream=e,this.pc.addStream(e)}},{key:"_safeCallback",value:function(e){return e||function(){return 1}}},{key:"_onIceCandidate",value:function(e){if(e.candidate){if(this.config.connectMediaServer)return void this.logger.debug("Dont send ice candidate: ",this.id);var n=e.candidate,t={candidate:{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex}};this.emit("iceCandidate",t)}else{this.logger.debug("iceEnd_onIceCandidate",e);var i={type:"offer",sdp:this.pc.localDescription.sdp};this.emit("iceEnd",i)}}},{key:"_onDataChannel",value:function(e){var n=e.channel;this.logger.debug("add new channel:",n),this.emit("addChannel",n)}},{key:"send",value:function(e,n){var t={to:this.id,sid:this.sid,type:e,payload:n};this.logger.debug("sending",e,t),this.parent.emit("message",t)}}]),n}(EventEmitter);
},{"eventemitter2":26,"webrtc-adapter":60}],72:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var o=0;o<t.length;o++){var n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,o,n){return o&&e(t.prototype,o),n&&e(t,n),t}}(),events=require("eventemitter2"),adapter=require("webrtc-adapter"),socketio=require("socket.io-client"),Promise=require("promise"),WebRTC=require("./webrtc"),EventEmitter=events.EventEmitter2;module.exports=function(e){function t(e){_classCallCheck(this,t);var o=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));o.self=o,o.logger=console,o.options=e||{},o.connection=null,o.connectionReady=!1,o.roomName=null,o.localStream=null,o.config={autoConnect:!0,connectMediaServer:!1,username:!1,url:"https://roomrtc-signaling-server.herokuapp.com",media:{audio:!1,video:!0},peerMediaConstraints:{offerToReceiveVideo:!0,offerToReceiveAudio:!0},localVideo:{autoplay:!0,mirror:!0,muted:!0}};for(var n in o.options)o.options.hasOwnProperty(n)&&(o.config[n]=o.options[n]);return o.webrtc=new WebRTC,o.webrtc.on("peerStreamAdded",o.handlePeerStreamAdded.bind(o)),o.webrtc.on("peerStreamRemoved",o.handlePeerStreamRemoved.bind(o)),o.webrtc.on("message",function(e){o.logger.debug("send message command",e),o.connection.emit("message",e)}),o.webrtc.onAny(function(e,t){o.emit.call(o,e,t)}),o.onAny(o.logger.debug.bind(o.logger,"RoomRTC event:")),o.config.autoConnect&&o.connect(),o}return _inherits(t,e),_createClass(t,[{key:"connect",value:function(){var e=this;this.connection=socketio.connect(this.config.url),this.connection.on("connect",function(){e.connectionReady=!0,e.connectionId=e.connection.id,e.emit("connected",e.connectionId),e.verifyReady()}),this.connection.on("message",function(t){if("offer"==t.type){var o=e.webrtc.peers.find(function(e){return e.sid==t.sid});o||(e.logger.debug("Creating a new peer connection to:",t.from),o=e.webrtc.createPeerConnection({id:t.from,sid:t.sid}),e.emit("peerCreated",o)),o.processMessage(t)}else{var n=e.webrtc.peers;n.forEach(function(e){t.sid?e.sid===t.sid&&e.processMessage(t):e.processMessage(t)})}}),this.connection.on("remove",function(t){e.logger.info("removePeerConnectionById",t),e.webrtc.removePeerConnectionById(t.id)}),this.connection.on("iceservers",function(t){e.logger.debug("Got iceservers info",t)})}},{key:"disconnect",value:function(){this.connection&&(this.connection.disconnect(),delete this.connection)}},{key:"verifyReady",value:function(){this.connectionReady&&(this.config.connectMediaServer?this.emit("readyToJoinMediaServer",this.connectionId):this.emit("readyToCall",this.connectionId))}},{key:"joinRoom",value:function(e){var t=this;return e?(this.roomName=e,new Promise(function(o,n){t.connection.emit("join",e,function(r,i){if(t.logger.debug("join callback: ",r,i),r)return t.emit("error",r),n(r);var c=i.clients||[];for(var a in c){var s=t.webrtc.createPeerConnection({id:a});t.emit("peerCreated",s),s.start()}return t.emit("roomJoined",e),o(i)})})):Promise.reject("No room to join")}},{key:"joinMediaServer",value:function(e){var t=this;return e?(this.roomName=e,new Promise(function(e,o){var n=(t.config.username||t.connectionId,t.webrtc.createPeerConnection({id:t.connectionId,connectMediaServer:t.config.connectMediaServer}));t.emit("peerCreated",n),n.start()})):Promise.reject("No room to join")}},{key:"createRoom",value:function(e){var t=this;return e?new Promise(function(o,n){t.connection.emit("create",e,function(e,n){return e?void t.emit("error",e):(t.roomName=n,t.emit("roomCreated",n),o(n))})}):Promise.reject("No room to create")}},{key:"initMediaSource",value:function(e,t){var o=this;this.logger.debug("Requesting local media ...");var n=e||this.config.media;return navigator.mediaDevices.getUserMedia(n).then(function(e){return o.localStream=e,o.webrtc.addLocalStream(e),e})}},{key:"stop",value:function(e){e=e||this.localStream,this.stopStream(e)}},{key:"stopStream",value:function(e){if(e){var t=!0,o=!1,n=void 0;try{for(var r,i=e.getAudioTracks()[Symbol.iterator]();!(t=(r=i.next()).done);t=!0){var c=r.value;try{c.stop()}catch(e){this.logger.debug("stop audio track error:",e)}}}catch(e){o=!0,n=e}finally{try{!t&&i.return&&i.return()}finally{if(o)throw n}}var a=!0,s=!1,u=void 0;try{for(var d,l=e.getVideoTracks()[Symbol.iterator]();!(a=(d=l.next()).done);a=!0){var f=d.value;try{f.stop()}catch(e){this.logger.debug("stop video track error:",e)}}}catch(e){s=!0,u=e}finally{try{!a&&l.return&&l.return()}finally{if(s)throw u}}if("function"==typeof e.stop)try{e.stop()}catch(e){}}}},{key:"getStreamAsUrl",value:function(e){var t=window.URL||window.webkitURL;return t.createObjectURL(e)}},{key:"revokeObjectURL",value:function(e){var t=window.URL||window.webkitURL;t.revokeObjectURL(e)}},{key:"handlePeerStreamAdded",value:function(e){var t=e.stream;this.logger.debug("A new remote video added:",e.id),this.emit("videoAdded",e,t)}},{key:"handlePeerStreamRemoved",value:function(e){this.logger.debug("A remote video removed:",e.id),this.emit("videoRemoved",e)}}]),t}(EventEmitter);
},{"./webrtc":73,"eventemitter2":26,"promise":37,"socket.io-client":46,"webrtc-adapter":60}],73:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),events=require("eventemitter2"),adapter=require("webrtc-adapter"),PeerConnection=require("./peerconnection"),EventEmitter=events.EventEmitter2;module.exports=function(e){function t(e){_classCallCheck(this,t);var n=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return n.self=n,n.logger=console,n.config={peerConnectionConfig:{iceServers:[{urls:"stun:stun.l.google.com:19302"}]},peerConnectionConstraints:{optional:[]},receiveMedia:{offerToReceiveAudio:1,offerToReceiveVideo:1},enableDataChannels:!0},n.peers=[],n.localStreams=[],n}return _inherits(t,e),_createClass(t,[{key:"_removeStream",value:function(e){var t=this.localStreams.indexOf(e);t>-1&&this.localStream.splice(t,1)}},{key:"setPeerConnectionConfig",value:function(e,t){this.config.peerConnectionConfig=e,this.config.peerConnectionConstraints=t}},{key:"isAllTracksEnded",value:function(e){var t=!0,n=!0,r=!1,o=void 0;try{for(var i,a=e.getTracks()[Symbol.iterator]();!(n=(i=a.next()).done);n=!0){var c=i.value;if("ended"!==c.readyState){t=!1;break}}}catch(e){r=!0,o=e}finally{try{!n&&a.return&&a.return()}finally{if(r)throw o}}return t}},{key:"addLocalStream",value:function(e){this.localStreams.push(e)}},{key:"createPeerConnection",value:function(e){e=e||{},e.parent=this;var t=new PeerConnection(e);return this.peers.push(t),t}},{key:"removePeerConnection",value:function(e){var t=this.peers.indexOf(e);t&&this.peers.splice(t,1)}},{key:"removePeerConnectionById",value:function(e){this.peers.some(function(t){if(t.id==e)return t.end(),!0})}},{key:"localStream",get:function(){return this.localStreams.length>0?this.localStreams[0]:null}}]),t}(EventEmitter);
